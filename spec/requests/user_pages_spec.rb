...
describe "User pages" do
    ...
    describe "index" do
            ...
            describe "as an admin user" do
                ...
                it "should be able to delete another user" do
                    expect { click_link('delete', match: :first) }.to change(User, :count).by(-1)
                        #match: first 告知 Capybara，不管是哪个删除链接，只点击第一个看到的。
                end
        ...
        describe "as admin user" do
            ...
            describe "submitting a DELETE request to the Users#destroy action for delete himself" do
    ...
    describe "edit" do
        ...
        describe "page" do
            ...
            it { should have_link("change", href: "http://en.gravatar.com/gravatars/new/") }
        end
